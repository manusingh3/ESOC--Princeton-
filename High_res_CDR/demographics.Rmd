...
The two sample t test with a very high p value sugget that null hypothesis cannot be rejected and the two groups are significantly similar
```{r echo =FALSE, warning=FALSE, error=FALSE}
...
3. Requested Niall for a list of important (top 5) baseline CDR variables- for Cell Phone use+bandicoot featues for the whole country.
